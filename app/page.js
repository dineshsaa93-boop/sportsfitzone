...
import {
  ...
  Apple, LineChart, Dna, Moon, Watch, HelpCircle, CalendarDays, ClipboardList,
  Crown, GraduationCap, Gamepad2, Video, Gift, User, MessageCircle,
  FileText, BookOpen, Users, Bot, CalendarCheck, Home, Dumbbell, MonitorPlay, MessageCircleQuestion
} from "lucide-react";

// ==========================================
// 1. DYNAMIC DATA SOURCE (NO HARDCODING)
// ==========================================
// Bhai, agar 100% exact wahi image wale icons chahiye, 
// toh inme 'imgSrc' me apne asli icon ka path daal dena (e.g., '/assets/diet-icon.png').
// Jab tak path nahi daloge, ye neon glowing style fallback icons dikhayega.
const APP_DATA = {
  user: {
    name: "DINESH",
    level: "Elite Athlete",
  ...
  features: [
    { id: 1, title: "Diet Planner", icon: Apple, color: "#39ff14", imgSrc: "" },
    { id: 2, title: "Progress", icon: LineChart, color: "#39ff14", imgSrc: "" },
    { id: 3, title: "Transformation", icon: Dna, color: "#3ea6ff", imgSrc: "" },
    { id: 4, title: "Sleep", icon: Moon, color: "#9d4edd", imgSrc: "" },
    { id: 5, title: "Water Tracker", icon: Droplet, color: "#3ea6ff", imgSrc: "" },
    { id: 6, title: "Workout Timer", icon: Timer, color: "#e2e8f0", imgSrc: "" },
    { id: 7, title: "Quiz", icon: Brain, color: "#ff4d88", imgSrc: "" },
    { id: 8, title: "Workout Schedule", icon: CalendarDays, color: "#ff4d88", imgSrc: "" },
    { id: 9, title: "Notes", icon: ClipboardList, color: "#ffaa00", imgSrc: "" },
    { id: 10, title: "Leaderboard", icon: Crown, color: "#ffd700", imgSrc: "" },
      ...
      <style>{`
        * { box-sizing: border-box; font-family: 'Inter', system-ui, sans-serif; }
        ...
        .feature-item-wrapper {
          display: flex; flex-direction: column; align-items: center; cursor: pointer; width: 100%; max-width: 90px;
        }
        ...
        /* Show More/Less Button matching user image */
        .show-more-btn {
          width: 100%; background: #1a2235; border: none; color: white; 
          padding: 15px; border-radius: 16px; font-weight: bold; font-size: 16px; 
          cursor: pointer; display: flex; justify-content: center; align-items: center; gap: 10px; margin-top: 20px; transition: background 0.2s;
        }
        .show-more-btn:hover { background: #232d45; }
        ...
        @media (max-width: 850px) {
          ...
          .grid-features { grid-template-columns: repeat(4, 1fr); gap: 20px 10px; }
        }
